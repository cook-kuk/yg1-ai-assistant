...
const FIELD_ALIAS = {
  ...
  RadiusAll: ['cornerRadiusMm', 'radiusAll'],
  RadiusofBallNose: ['ballNoseRadiusMm', 'radiusOfBallNose'],
  NeckDiameter: ['neckDiameterMm', 'neckDiameter'],
  LengthbelowShank: ['lengthBelowShankMm', 'lengthBelowShank'],
  Cutter_Diameter: ['cutterDiameterMm', 'cutterDiameter'],
  ...
  SingleDoubleEnd: ['singleDoubleEnd'],
  RoughingFinishtype: ['roughingFinishType'],
