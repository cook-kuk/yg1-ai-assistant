# YG-1 — TDE01
**제품명**: TiN TDE01 SERIES / COMBO TAP / Unified coarse threads UNC
...
## 상세 정보 (원문 요약)
- [page_0289] COMBO TAP의 Unified coarse threads(UNC)용 머신 탭 시리즈이다. 특수한 탭 형상으로 다양한 용도에 맞는 정확한 나사 형상과 긴 공구 수명을 제공하며, YG-1 특허 제품이라고 설명한다. TDE01은 TiN 시리즈이며 TCE01 Bright 시리즈와 함께 제시되고, #4부터 1까지의 규격과 각 치수/드릴 직경이 표로 수록되어 있다.
