...
- 📎 **리포트 파일**: [`reports/latest-metrics.xlsx`](reports/latest-metrics.xlsx) _(클릭하여 열기, 갱신일 2026-04-07)_
- 🎯 **정확도 4/25** · 누락 10건 · 평균 오차 419
...
```
Finder 25 케이스 — DB vs 내(:3000) vs 수찬님(:2999)
DB ground truth | 내 (:3000) | 수찬님 (:2999)
총 케이스 | 25 | 25 | 25
DB 정확 매칭 | — | 4 | 0
정확도 | — | 16% | 0%
verdict 분포 | 내 | 수찬님
