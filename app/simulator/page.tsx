...
import { CuttingSimulator } from "@/lib/frontend/simulator/cutting-simulator"
      ...
      <div className="border-b bg-white/95">
        <div className="mx-auto max-w-6xl px-4 py-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-700">
              BETA
            </span>
          </div>
          <p className="mt-1 text-sm text-gray-500">
            YG-1 카탈로그 데이터 기반 절삭조건 시뮬레이션
          </p>
        </div>
      </div>
