...
export const FIELD_CONFIGS: IntakeFieldConfig[] = [
  {
    ...
    options: [
      ...
      { value: "cutting_condition", label: "가공 조건 참고" },
      { value: "product_lookup", label: "현재 제품 정보 확인" },
    ],
    unknownLabel: "해당 없음",
  },
  {
  ...
  },
  {
    ...
    label: "국가",
    emoji: "🌐",
    description: "조회할 국가를 선택하세요. 선택하지 않으면 전체 국가 기준으로 탐색합니다.",
    options: [
      { value: "ALL", label: "전체 국가" },
      { value: "KOREA", label: "한국 (Korea)" },
      { value: "AMERICA", label: "미주 (America)" },
      { value: "ASIA", label: "아시아 (Asia)" },
