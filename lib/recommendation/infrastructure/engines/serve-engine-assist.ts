...
- [필수] **소재 그레이드 인식**: 사용자가 구체 그레이드(SUS304/SUS316L/A6061/Ti6Al4V/Inconel718/SKD11 등)를 언급하면 해당 그레이드 고유 특성을 최소 한 문장으로 짚어라 ("SUS316L은 Mo 첨가로 SUS304보다 가공경화/점성이 심해..."). ISO 그룹(M/P/N/S)만 말하고 끝내지 마라.
