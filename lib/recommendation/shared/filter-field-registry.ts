...
const FILTER_FIELD_DEFINITIONS: Record<string, FilterFieldDefinition> = {
  ...
  machiningCategory: {
    ...
    label: "가공 분류",
    queryAliases: ["가공 분류", "category", "machining category", "가공계열", "가공 카테고리", "밀링", "milling", "홀메이킹", "holemaking", "쓰레딩", "threading"],
    kind: "string",
    matchPolicy: "strict_identifier",
    op: "eq",
    dbColumns: ["edp_root_category"],
