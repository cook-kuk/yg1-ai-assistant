...
const ENTITY_NODES: EntityNode[] = [
  ...
  // coating (including YG-1 internal names: X/Y/C-Coating)
  ...
  { canonical: "DLC", field: "coating", aliases: ["dlc", "디엘씨"] },
  { canonical: "Uncoated", field: "coating", aliases: ["uncoated", "무코팅", "브라이트", "bright", "bright finish"] },
  // workPieceName (expanded with JIS grades + common expressions)
  { canonical: "Stainless Steels", field: "workPieceName", aliases: ["스테인리스", "스텐", "sus", "stainless", "sus304", "sus316", "sus316l", "sus303", "sus420", "sus630", "sts304"] },
  { canonical: "Carbon Steels", field: "workPieceName", aliases: ["탄소강", "carbon steel", "carbon", "s45c", "s50c", "s55c", "sk3", "sk5"] },
  { canonical: "Alloy Steels", field: "workPieceName", aliases: ["합금강", "alloy steel", "alloy", "scm440", "scm415", "sncm439", "suj2", "금형강", "구조용강"] },
  { canonical: "Cast Iron", field: "workPieceName", aliases: ["주철", "cast iron", "주물", "fc", "fcd"] },
  { canonical: "Aluminum", field: "workPieceName", aliases: ["알루미늄", "알미늄", "aluminum", "aluminium", "a6061", "a7075", "a5052", "두랄루민"] },
  { canonical: "Titanium", field: "workPieceName", aliases: ["티타늄", "titanium", "ti6al4v", "초내열합금", "내열합금"] },
  ...
  // Boolean: coolantHole
  { canonical: "true", field: "coolantHole", aliases: ["쿨런트", "쿨런트홀", "절삭유홀", "coolant", "coolant hole", "내부급유"] },
  // Countries
